...
create table `aap_page` (
    ...
    `urlmark` varchar(128) NOT NULL DEFAULT '' COMMENT 'what to display in page part in the url',
...
create table `aap_header` (
    ...
    `uniqkey` varchar(128) NOT NULL COMMENT 'unique key',
...
create table `aap_form_input` (
    ...
    `default` varchar(1024) NOT NULL DEFAULT '' COMMENT 'default value', 
