...
let FormComp = React.createClass({
    ...
    submit: function(e, postApi) {
        ...
        $.ajax({
            ...
            success: function(retData, status) {
                ...
                let errno = basic.getField(retData, ['errno']);
                ...
                const refreshContentFunc = basic.getField(
                    thisForm, 
    ...
    render: function() {
        ...
        const componentsContent = basic.decode(
            basic.getField(data, ['components'])
        );
        ...
        if (data == undefined || data['id'] != this.props.params.form) {
            ...
            let postApi = basic.getField(query, ['post_api']);
            switch(basic.getField(query, ['type'])) {
            case 'view':
                modalFooter['footer'] = [];
                break;
            case 'edit':
