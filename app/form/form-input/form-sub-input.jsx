...
var CommonSubInputMixin = { // 子input在初始时要通知父控件的函数
    ...
    getRemoteDataValue: function(props, field) {
        ...
        return basic.getField(basic.decode(remoteData), [field]);
    },
    ...
    getExtraMessage: function(props) {
        ...
        return basic.getField(data, ['help_message']);
    },
};
...
let SelectFormSubInput = React.createClass({
    ...
    getInitialState: function() {
        ...
        return {
            optionList: basic.getField(detailContent, ['option_list']) || [],
    ...
    render: function() {
        ...
        return (
            <Form.Item
                ...
                <Select
                    tags={basic.getField(detailContent, ['multi'], false)}
...
let RelationFormSubInput = React.createClass({
    ...
    getInitialState: function() {
        ...
        return {
            relationList: basic.getField(detailContent, ['relation_list']) || [],
            selectedValue: this.getCurrentValue(),
        };
    },
